...
st.title("RAG SYSTEM for PDF browsing")
user_input = st.text_input("Enter text ....")

chat_model = ChatGoogleGenerativeAI(google_api_key="AIzaSyCZ-ICdoY4xHgbptapJnP-YWWGmAQMMcS0", 
...
#Loading Document
loader = PyPDFLoader(r"C:\Users\Admin\Internship\RAG App using Langchain\pdf.pdf")
...
embedding_model = GoogleGenerativeAIEmbeddings(google_api_key="AIzaSyCZ-ICdoY4xHgbptapJnP-YWWGmAQMMcS0", 
